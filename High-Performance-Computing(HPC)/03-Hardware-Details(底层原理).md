既然你的目录结构已经清晰，接下来我们要填充最硬核的部分：`03-Hardware-Details.md`。

这份笔记是理解“伪共享”为什么会拖慢并行的关键。作为 IT 专业人士，你需要掌握 **MESI 协议** 的四种状态，这不仅是为了考试，更是为了在逆向（Reverse Engineering）或高并发开发中理解 CPU 的真实行为。

---

### 📂 03-Hardware-Details.md 核心笔记内容
